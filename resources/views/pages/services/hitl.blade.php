    ...
    <div class="container mx-auto px-6 max-w-7xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20">
            <div class="lg:col-span-7">
                <h2 class="text-3xl font-black text-white mb-6">{{ __('pages.HITL_TITLE') }}</h2>
                <p class="text-slate-400 leading-relaxed text-lg mb-8">
                    {{ __('pages.HITL_DESC') }}
                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('contact') }}" class="inline-block bg-gradient-to-r from-brand-green to-brand-teal text-dark-navy font-black px-8 py-4 rounded-full shadow-lg shadow-brand-green/20 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 text-center">
            ...
            <div class="lg:col-span-5 relative">
                ...
                <div class="relative bg-slate-900/60 text-white rounded-3xl p-8 border border-white/5 shadow-xl font-mono text-xs backdrop-blur-md">
                    <div class="flex items-center justify-between border-b border-white/5 pb-3 mb-4">
                        <span class="text-brand-green font-bold">Inference Queue</span>
                    ...
                    <div class="space-y-3">
                        <div class="bg-slate-950/40 p-3 rounded-lg border border-white/5">
                            <div class="text-slate-500 mb-1">Input Prompt:</div>
                            <div class="text-white">"اكتب عقد إيجار موثق متوافق مع نظام المعاملات المدنية"</div>
                        </div>
                        <div class="bg-slate-950/40 p-3 rounded-lg border border-white/5">
                            <div class="text-slate-500 mb-1">Model Inference:</div>
                            <div class="text-white font-serif">"عقد الإيجار يخضع لنظام..." <span class="text-red-400 font-bold">[Confidence: 62%]</span></div>
                        </div>
                        <div class="bg-brand-green/10 p-3 rounded-lg border border-brand-green/20 flex items-center justify-between">
                            <span class="text-brand-green font-bold">✔️ Routed to Legal Expert for verification</span>
                            <span class="animate-pulse w-2.5 h-2.5 rounded-full bg-brand-green shadow-green-glow"></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mb-16">
            <h2 class="text-3xl font-black text-white mb-4">{{ __('pages.HITL_FEATURES_TITLE') }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="expert-card p-8 hover:shadow-lg transition-all duration-300">
                ...
                <h3 class="text-xl font-bold text-white mb-3">{{ __('pages.HITL_FEAT_1_TITLE') }}</h3>
            ...
            <div class="expert-card p-8 hover:shadow-lg transition-all duration-300">
                ...
                <h3 class="text-xl font-bold text-white mb-3">{{ __('pages.HITL_FEAT_2_TITLE') }}</h3>
                <p class="text-slate-400 text-sm leading-relaxed">
            ...
            <div class="expert-card p-8 hover:shadow-lg transition-all duration-300">
                ...
                <h3 class="text-xl font-bold text-white mb-3">{{ __('pages.HITL_FEAT_3_TITLE') }}</h3>
                <p class="text-slate-400 text-sm leading-relaxed">
