        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : (document.dir === 'rtl' ? 'translate-x-full' : '-translate-x-full')" 
            ...
            <div class="flex flex-col justify-between flex-1 mt-6">
                <nav class="-mx-3 space-y-1">
                    ...
                    <a class="flex items-center px-4 py-2.5 {{ request()->routeIs('admin.ai_feedback.*') ? 'text-white bg-sidebar-hover' : 'text-slate-400 hover:bg-sidebar-hover hover:text-white' }} rounded-lg transition group" href="{{ route('admin.ai_feedback.index') }}">
                        <i class="fa-solid fa-thumbs-up w-6 text-center group-hover:text-white transition {{ request()->routeIs('admin.ai_feedback.*') ? 'text-white' : '' }}"></i>
                        <span class="mx-3 font-medium">تقييمات الإجابات (Feedback)</span>
                    </a>
                    <a class="flex items-center px-4 py-2.5 {{ request()->routeIs('admin.ai_packages.*') ? 'text-white bg-sidebar-hover' : 'text-slate-400 hover:bg-sidebar-hover hover:text-white' }} rounded-lg transition group" href="{{ route('admin.ai_packages.index') }}">
                        <i class="fa-solid fa-box-open w-6 text-center group-hover:text-white transition {{ request()->routeIs('admin.ai_packages.*') ? 'text-white' : '' }}"></i>
                        <span class="mx-3 font-medium">باقات المساعد الذكي</span>
                    </a>
