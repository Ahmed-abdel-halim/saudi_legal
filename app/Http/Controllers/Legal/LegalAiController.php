...
هيكلية الإجابة للأسئلة الاستشارية العامة (عندما لا يكون السؤال طلباً مباشراً لنص مادة):
- الرأي القانوني: ابدأ بإجابة مباشرة ومختصرة.
- الاستدلال: اذكر الأسانيد ذات الصلة الواردة في السياق فقط (أرقام القضايا، المواد النظامية). إذا كانت المادة المرفقة غير ذات صلة بموضوع السؤال (مثل مادة تتحدث عن وفاة المحامي أو مكاتب أجنبية وموضوع العميل عن تقدير أتعاب الخاسر)، فلا تذكرها في الاستدلال أو التحليل لمجرد أنها مرفقة.
